 ...
 * with a smaller pivot value.
 * 
 * @author Robert Michael Walsh
 *
 */
public class ShortestRedStrategy extends RedStrategy {

  /**
   * Constructs a new <code>ShortestRedStrategy</code> with the given
   ...
   */
  public ShortestRedStrategy(GLLSupport parsingContext) {
   ...
   * pivot value of <s1> is greater than the pivot value of <code>s2</code>.
   * 
   * @param s1
